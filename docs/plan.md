...
**관련 문서**: [용어집](glossary.md) | [비즈니스 컨텍스트](business-requirements.md) | [기술 명세서](techspec/techspec.md)
...
- [Moon Web 구현 계획](#moon-web-구현-계획)
  ...
  - [Phase 1: 핵심 인프라 구축](#phase-1-핵심-인프라-구축)
    - [1. 인증 시스템](#1-인증-시스템)
    - [2. 라우팅 및 네비게이션](#2-라우팅-및-네비게이션)
    - [3. 공통 컴포넌트](#3-공통-컴포넌트)
  - [Phase 2: 출입통제 (Access Control) - 핵심 기능](#phase-2-출입통제-access-control---핵심-기능)
    - [1. 장치 관리](#1-장치-관리)
    - [2. 출입문 관리](#2-출입문-관리)
    - [3. 사용자 인증 관리](#3-사용자-인증-관리)
    - [4. 출입 권한 관리](#4-출입-권한-관리)
    - [5. 이벤트 및 로그](#5-이벤트-및-로그)
    - [6. 구역 및 알람](#6-구역-및-알람)
  - [Phase 3: 방문자 관리 (Visitor Management)](#phase-3-방문자-관리-visitor-management)
    - [1. 방문 일정 관리](#1-방문-일정-관리)
    - [2. 방문자 체크인/체크아웃](#2-방문자-체크인체크아웃)
    - [3. 방문 스케줄 상태](#3-방문-스케줄-상태)
  - [Phase 4: 조직 및 계층 관리](#phase-4-조직-및-계층-관리)
    - [1. 출입통제 계층](#1-출입통제-계층)
    - [2. 방문자 관리 계층](#2-방문자-관리-계층)
  - [Phase 5: 사용자 및 권한 관리](#phase-5-사용자-및-권한-관리)
    - [1. 계정 유형 구현](#1-계정-유형-구현)
    - [2. 역할 구현](#2-역할-구현)
    - [3. 계정 상태 관리](#3-계정-상태-관리)
    - [4. 멤버 관리](#4-멤버-관리)
  - [Phase 6: I/O 모듈 및 릴레이 관리](#phase-6-io-모듈-및-릴레이-관리)
    - [1. I/O 모듈](#1-io-모듈)
    - [2. 릴레이 제어](#2-릴레이-제어)
  - [Phase 7: 스케줄 관리](#phase-7-스케줄-관리)
    - [1. 스케줄 유형](#1-스케줄-유형)
    - [2. 스케줄 적용](#2-스케줄-적용)
  - [Phase 8: 플러그인 연동](#phase-8-플러그인-연동)
    - [1. 외부 시스템 동기화](#1-외부-시스템-동기화)
    - [2. Webhook](#2-webhook)
    - [3. OAuth 연동](#3-oauth-연동)
  - [Phase 9: 고급 기능](#phase-9-고급-기능)
    - [1. 대시보드 및 리포트](#1-대시보드-및-리포트)
    - [2. 실시간 알림](#2-실시간-알림)
    - [3. 통합 기능](#3-통합-기능)
  - [Phase 10: AI 및 분석](#phase-10-ai-및-분석)
    - [1. 이상 행위 탐지](#1-이상-행위-탐지)
    - [2. 출입 패턴 분석](#2-출입-패턴-분석)
    - [3. 예측 유지보수](#3-예측-유지보수)
    - [4. 대시보드 자동화](#4-대시보드-자동화)
  - [비기능 요구사항](#비기능-요구사항)
    - [1. 성능 최적화](#1-성능-최적화)
    - [2. 보안](#2-보안)
    - [3. 테스트](#3-테스트)
